...
return new class extends Migration
{
    ...
    {
        Schema::table('kartu_spp', function (Blueprint $table) {
            $table->string('external_source', 50)->nullable()->after('keterangan');
            ...
            $table->unique(['external_source', 'external_reference'], 'kartu_spp_external_unique');
        });
    }
    ...
    {
        Schema::table('kartu_spp', function (Blueprint $table) {
            $table->dropUnique('kartu_spp_external_unique');
